...
## Project Structure
    ...
    ├── minecraft_mod_maker_43909  # Django project configurations
...
1. Clone this repo and `cd minecraft_mod_maker_43909`
...
2. Clone this repo and `cd minecraft_mod_maker_43909`
